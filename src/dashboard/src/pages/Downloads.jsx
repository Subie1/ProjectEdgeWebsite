...
export default function Downloads() {
	...
	return (
		<main className="w-full overflow-hidden items-center justify-center gap-4 h-full flex flex-col">
			<header className="text-xl md:text-4xl text-center font-bold gap-2 md:gap-4 flex items-center justify-center">
				<span>Download</span>
				<span className="relative flex mx-2 md:mx-4 items-center justify-center">
					<span className="tracking-widest">Project</span>
					<div className="absolute left-full bottom-0 w-2 md:w-4 animate-pulse h-1 bg-gradient-to-br from-primary via-accent to-secondary"></div>
				</span>
				<span className="text-transparent bg-gradient-to-br bg-clip-text from-primary via-accent to-secondary">
					Edge
				</span>
			</header>
			<div className="flex gap-2">
				...
				>
					<Icon
						name="TbBrandWindows"
						className={`${page === 0 ? "fill-text" : ""} text-2xl`}
					/>
				...
				>
					<VscTerminalLinux
						className={`${page === 1 ? "fill-text" : ""} text-2xl`}
					/>
				...
				>
					<Icon
						name="TbBrandApple"
						className={`${page === 2 ? "fill-text" : ""} text-2xl`}
					/>
			...
			<div className="flex flex-col gap-2">
				{urls.map((url) => (
					<a
						key={url}
						className="rounded-xl text-center bg-primary px-4 py-2 text-background"
						href={url}
						download
					>
